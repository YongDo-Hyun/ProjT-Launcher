...
namespace Meta
{
	...
	class VersionList : public BaseVersionList, public BaseEntity
	{
	  ...
	  public:
		...
		QList<Version::Ptr> versions() const
		{
			return m_versions;
		}
	  ...
	  private:
		...
		RoleList m_provided_roles = { VersionPointerRole, VersionRole,	   VersionIdRole, ParentVersionRole,
									  TypeRole,			  UidRole,		   TimeRole,	  RequiresRole,
